<div class="sidebar">
    <ul class="navigation">
        ...
        <li><a href="/attendance" class="<?php if(trim($_SERVER['REQUEST_URI'], '/') == 'attendance'): echo 'active'; endif; ?>"><i class="fa fa-clock-o" aria-hidden="true"></i> <span>Attendance</span></a></li>
